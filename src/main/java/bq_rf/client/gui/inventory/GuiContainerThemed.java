...
public abstract class GuiContainerThemed extends GuiScreenThemed
{
    ...
    public void drawScreen(int mx, int my, float partialTick)
    {
        ...
        int k = this.guiLeft;
        int l = this.guiTop;
        this.drawGuiContainerBackgroundLayer(partialTick, mx, my);
    ...
    protected abstract void drawGuiContainerBackgroundLayer(float partialTick, int mx, int my);
    ...
    private void func_146980_g()
    {
        ...
        if (itemstack != null && this.field_147007_t)
        {
            ...
            for (Iterator<Slot> iterator = this.field_147008_s.iterator(); iterator.hasNext(); this.field_146996_I -= itemstack1.stackSize - i)
            {
    ...
    protected void mouseClicked(int p_73864_1_, int p_73864_2_, int p_73864_3_)
    {
        ...
        if (p_73864_3_ == 0 || p_73864_3_ == 1 || flag)
        {
            int i1 = this.guiLeft;
            int j1 = this.guiTop;
            boolean flag1 = p_73864_1_ < i1 || p_73864_2_ < j1 || p_73864_1_ >= i1 + this.sizeX || p_73864_2_ >= j1 + this.sizeY;
            int k1 = -1;
	...
	protected void mouseMovedOrUp(int p_146286_1_, int p_146286_2_, int p_146286_3_)
    {
        ...
        int l = this.guiLeft;
        int i1 = this.guiTop;
        boolean flag = p_146286_1_ < l || p_146286_2_ < i1 || p_146286_1_ >= l + this.sizeX || p_146286_2_ >= i1 + this.sizeY;
        int j1 = -1;

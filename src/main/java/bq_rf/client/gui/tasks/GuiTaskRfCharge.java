...
public class GuiTaskRfCharge extends GuiElement implements IGuiEmbedded
{
	...
	private TaskRfCharge task;
	
	public GuiTaskRfCharge(IQuest quest, TaskRfCharge task, int posX, int posY, int sizeX, int sizeY)
	{

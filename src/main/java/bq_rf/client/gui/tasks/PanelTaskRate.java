...
public class PanelTaskRate extends CanvasEmpty
{
    ...
    public void initPanel()
    {
        ...
        this.addPanel(new PanelTextBox(new GuiTransform(new Vector4f(0.25F, 0.5F, 0.75F, 0.5F), new GuiPadding(0, 4, 0, -16), -1), TextFormatting.BOLD + strReq + " RF/t").setAlignment(1));
    }
